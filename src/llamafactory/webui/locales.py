LOCALES = {
    ...
    "model_path": {
        ...
        "zh-tw": {
            "label": "模型路徑",
            "info": "本地模型的文件路徑或 Hugging Face 的模型標識符。"
        },
        "ko": {
            "label": "모델 경로",
    ...
    "freeze_extra_modules": {
        ...
        "ru": {
            ...
            "info": "Имена модулей, кроме скрытых слоев, которые следует установить в качестве обучаемых. Используйте запятые для разделения нескольких модулей."
        },
        "zh": {
            "label": "额外模块（非必填）",
        ...
        "zh-tw": {
            "label": "額外模塊（非必填）",
            "info": "除隱藏層以外的可訓練模塊名稱。使用英文逗號分隔多個名稱。"
        },
        "ko": {
            "label": "추가 모듈 (선택 사항)",
    ...
    "lora_target": {
        ...
        "zh-tw": {
            "label": "LoRA 作用模塊（非必填）",
            "info": "應用 LoRA 的模塊名稱。使用英文逗號分隔多個名稱。"
        },
        "ko": {
            "label": "LoRA 모듈 (선택 사항)",
    ...
    "additional_target": {
        ...
        "zh-tw": {
            "label": "附加模塊（非必填）",
            "info": "除 LoRA 層以外的可訓練模塊名稱。使用英文逗號分隔多個名稱。"
        },
        "ko": {
            "label": "추가 모듈 (선택 사항)",
    ...
    "galore_target": {
        ...
        "zh-tw": {
            "label": "GaLore 作用模塊",
            "info": "應用 GaLore 的模塊名稱。使用英文逗號分隔多個名稱。"
        },
        "ko": {
            "label": "GaLore 모듈",
